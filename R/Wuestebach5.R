...
setwd("D:/Droesen/Datasets/Wüstebach/SM_SOILNet_WUE_2009_2013/SM_5cm/")
list.files(path="D:/Droesen/Datasets/Wüstebach/SM_SOILNet_WUE_2009_2013/SM_5cm/", pattern=".txt") -> fileName5

#change filenames

#read files
testfolder <- "D:/Droesen/Datasets/Wüstebach/SM_SOILNet_WUE_2009_2013/Test5/"
i <- 2
for (fileName in fileName5) {
  ...
  write.csv(averaged_over_day, paste(testfolder, "GemID", "5", formatC(i, width=3, flag="0"), '.csv', sep="_") )
  i <- i + 1
}
